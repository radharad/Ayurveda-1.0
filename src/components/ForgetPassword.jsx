...
<div className='bgForget'>
       <div className='Forget md:w-[900px] bg-[#122926] mx-auto my-[90px]'>
        <div className='grid md:grid-cols-2 grid-cols-1 items-center'>
         ...
         <div className=' border border-[#5a5959] md:ml-[50px] md:py-[62px]'>
          ...
          <form className='text-white'>
            ...
            <button className='bg-[#4d8f84] w-[100%] p-2 font-bold rounded'>Recover</button>
          ...
          <p><img src='images/LoginLogo.png' className='h-[200px] w-[200px]   sm:pb-0 pb-5 ml-[80px]' alt='img'/></p>
