...
export default function Register() {
  return (
    <div>
      <div className='bgRegister'>
       <div className='RegisterElement md:w-[900px] bg-[#122926] mx-auto my-[50px] px-[50px]'>
        <div className='inner md:w-[900px] border border-[#5a5959]'>
          ...
          <p className='text-[#F2DA16] font-bold'>UserID: <span className='text-[#4d8f84]'>RHI218277</span></p>
      ...
      <div className="flex flex-wrap -m-2">
        <div className="p-2 md:w-1/2">
          <div className="relative">
            ...
            <input type="password" id="password" name="password" className="w-full bg-transparent bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500  focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" placeholder='Enter Password'/>
          </div>
        </div>
  ...
  <div className='mt-[30px]'><input type='checkbox' checked/></div><span className='relative left-[20px] bottom-6'>I agree to the<span className='text-[#4d8f84]'> Terms Conditions</span></span>
  <div className='py-[5px] text-center'>
  <button className='bg-[#4d8f84] p-2 text-center w-[200px] font-bold rounded'>Register</button>
  </div>
  <p className='float-right'>Already Have an account? <a href='/login' className='text-[#4d8f84]'>Log in</a></p>
  </div>
  </section>  
